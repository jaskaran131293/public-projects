...
<div class="nbd-gallery-con">
    ...
    ?>
    <h2><?php echo $title; ?> <?php _e('designs', 'teepro'); ?></h2>
    <?php endif; ?>
        ...
        ?>
            <div class="nbdesigner-item">
                <div class="nbd-gallery-item nbd-gallery-item-upload">
                    ...
                    <div class="nbd-gallery-item-upload-inner">
                        <a href="<?php echo $link_start_design; ?>" class="" target="_blank" title="<?php _e('Start design', 'teepro'); ?>">
                        <?php _e('Design or', 'teepro'); ?><br />
                        <?php _e('Upload file', 'teepro'); ?>   
                        </a>                        
                    </div>
                </div>
            </div>    
