...
<div class="show_if_seller"<?php echo esc_attr($role_style); ?>>
    ...
    <div class="split-row form-row-wide">
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( 'First Name', 'teepro' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php esc_html_e( 'Last Name', 'teepro' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Shop Name', 'teepro' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left">
			<?php esc_html_e( 'Shop URL', 'teepro' ); ?> <span class="required">*</span>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php esc_html_e( 'Phone Number', 'teepro' ); ?><span class="required">*</span></label>
    ...
    ?>
            <p class="form-row form-group form-row-wide">
                ...
                <label style="display: inline" for="tc_agree"><?php echo sprintf( __( 'I have read and agree to the <a target="_blank" href="%s">Terms &amp; Conditions</a>.', 'teepro' ), $toc_page_url ); ?></label>
            </p>    
            <?php } ?>
        <?php } ?>
...
<p class="form-row form-group user-role">
    <label class="radio">
        ...
        <?php esc_html_e( 'I am a customer', 'teepro' ); ?>
    </label>

    <label class="radio">
        <input type="radio" name="role" value="seller"<?php checked( $role, 'seller' ); ?>>
        <?php esc_html_e( 'I am a vendor', 'teepro' ); ?>
    </label>
